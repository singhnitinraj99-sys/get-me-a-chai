...
const Dashboard = () => {
    ...
    const handleSubmit = async (e) => {
        // Prevent default browser form behavior to let asynchronous code complete safely
        e.preventDefault();
        ...
        try {
            ...
            // Triggering Toast with explicit error catching parameters
            toast.success('Profile Updated Successfully!', {
                ...
                pauseOnHover: true,
                draggable: true,
                theme: "dark", // Switched to dark to match your dashboard theme profile
                transition: Bounce,
            })
        } catch (error) {
    ...
    return (
        <>
            {/* Kept only ONE single customized container instances to prevent overlay blocks */}
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
            ...
            <div className='container mx-auto py-5 px-6 '>
                ...
                {/* Changed to standard onSubmit listener to guarantee async function tracking */}
